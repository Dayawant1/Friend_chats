...
import com.example.friend_chats.Fragments.Adapters.ChatAdapter;
import com.example.friend_chats.Models.MessageModel;
import com.example.friend_chats.databinding.ActivityChatDetailBinding;
...
public class ChatDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(profilePic).placeholder(R.drawable.avtaricon).into(binding.profileImage);
